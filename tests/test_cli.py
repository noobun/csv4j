...
class TestScript:
    ...
    def test_cli_basic(self, case_dir):
    ...
    def test_cli_multiline(self, case_dir):
    ...
    def test_cli_custom_sep(self, case_dir):
        seps = [",", ";", "|"]
    ...
    def test_cli_verbose_flag(self, case_dir):
    ...
    def test_cli_carry_flag(self, case_dir):
